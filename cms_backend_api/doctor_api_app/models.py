...
class ConsultationNotes(models.Model):
    ...
    appointment_id = models.ForeignKey(Appointment, on_delete=models.CASCADE, related_name="consultations")
...
class PrescriptionMed(models.Model):
    ...
    appointment_id = models.ForeignKey(Appointment, on_delete=models.CASCADE, related_name="prescriptions_med")
...
class PrescriptionLab(models.Model):
    ...
    appointment_id = models.ForeignKey(Appointment, on_delete=models.CASCADE, related_name="prescriptions_lab")
