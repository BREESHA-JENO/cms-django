...
class DoctorDetailsSerializer(serializers.ModelSerializer):
    ...
    # ⬅️ Use schedules instead of working_days
    ...
    class Meta:
        ...
        fields = [
            ...
            "specialization_name",
            "consultation_fee",
            "schedules",   # ⬅️ nested doctor shifts
        ]
    ...
    def update(self, instance, validated_data):
        ...
        if schedules_data is not None:
            # Clear old schedules and replace with new ones
...
class StaffSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        """Customize output: hide doctor_details for non-doctors"""
